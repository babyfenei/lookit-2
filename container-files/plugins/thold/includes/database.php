...
function thold_upgrade_database () {
	...
	if (version_compare($oldv, '0.4.5', '<')) {
		...
		$data['columns'][] = array('name' => 'wxusers', 'type' => 'varchar(512)', 'NULL' => false);
		$data['primary'] = 'id';
		$data['type'] = 'MyISAM';
		...
		api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_send_wechat', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'disabled'));
		api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_host_wxuser', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'after' => 'thold_send_wechat'));
		...
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'warning_wxusers', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'warning_wxusers_extra'));
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'alert_wxusers', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'alert_wxusers_extra'));
		...
		api_plugin_db_add_column ('thold', 'thold_template', array('name' => 'warning_wxusers', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'warning_wxusers_extra'));
		api_plugin_db_add_column ('thold', 'thold_template', array('name' => 'alert_wxusers', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'alert_wxusers_extra'));
	...
	if (version_compare($oldv, '0.5.0.1', '<')) {
    	api_plugin_db_add_column ('thold', 'plugin_notification_lists', array('name' => 'wxusers', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'emails'));

		/*		
    	api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_send_wechat', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'default' => '1', 'after' => 'thold_host_email'));
		api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_host_wxuser', 'type' => 'int(10)', 'unsigned' => true, 'NULL' => false, 'after' => 'thold_send_wechat'));
		*/
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'alert_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'notify_warning_extra'));
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'warning_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'alert_wxusers_extra'));
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'alert_command', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'warning_wxusers_extra'));
		api_plugin_db_add_column ('thold', 'thold_data', array('name' => 'warning_command', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'alert_command'));

		api_plugin_db_add_column ('thold', 'thold_template', array('name' => 'alert_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'notify_warning_extra'));
		api_plugin_db_add_column ('thold', 'thold_template', array('name' => 'warning_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'alert_wxusers_extra'));
		api_plugin_db_add_column ('thold', 'thold_template', array('name' => 'alert_command', 'type' => 'varchar(512)', 'NULL' => true, 'after' => 'warning_wxusers_extra'));
...
function thold_setup_database () {
	...
	$data['columns'][] = array('name' => 'alert_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true);
	$data['columns'][] = array('name' => 'warning_wxusers_extra', 'type' => 'varchar(512)', 'NULL' => true);
	...
	$data['columns'][] = array('name' => 'warning_wxusers', 'type' => 'int(10)', 'NULL' => true, 'unsigned' => true);
	$data['columns'][] = array('name' => 'alert_wxusers', 'type' => 'int(10)', 'NULL' => true, 'unsigned' => true);
	...
	api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_send_wechat', 'type' => 'int(10)', 'NULL' => false, 'default' => '1', 'after' => 'disabled'));
	api_plugin_db_add_column ('thold', 'host', array('name' => 'thold_host_wxuser', 'type' => 'int(10)', 'NULL' => false, 'after' => 'thold_send_wechat'));
