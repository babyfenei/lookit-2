...
function thold_config_form () {
	...
	foreach ($fields_host_edit2 as $f => $a) {
		...
		if ($f == 'disabled') {
			...
			$fields_host_edit3['thold_send_wechat'] = array(
				'method' => 'drop_array',
				'array' =>  array('0' => 'Disabled', '1' => 'Global List', '2' => 'List Below', '3' => 'Global and List Below'),
				'friendly_name' => 'Thold Up/Down WECHAT Notification',
				'description' => 'Which Notification List(s) of should be notified about Host Up/Down events?',
				'value' => '|arg1:thold_send_wechat|',
				'on_change' => 'changeNotify()',
				'default' => '0',
				'form_id' => false
			);
			$fields_host_edit3['thold_host_wxuser'] = array(
				'friendly_name' => 'Notification List',
				'description' => 'Additional Phone address, separated by commas for multi Wechat Users.',
				'method' => 'drop_sql',
				'sql' => "SELECT id,name FROM plugin_notification_lists ORDER BY name",
				'value' => '|arg1:thold_host_wxuser|',
				'default' => '',
				'none_value' => 'None'
			);
		}
...
function thold_config_settings () {
	...
	$settings['alerts'] = array(
		...
		'thold_wechat_header' => array(
      'friendly_name' => 'WECHAT Sending Options',
      'method' => 'spacer',
     ),
			'thold_enable_wechat' => array(
			'friendly_name' => 'Enable Wechat sending',
			'description' => 'If checked, this will cause Cacti to send Wechat to users in Notification Lists.First of all, you must first create a WeChat account. Second, access to this URL you can know how to get created the Wechat CropID and Wechat Secret.  http://babyfenei.blog.51cto.com/443861/1728604',
			'method' => 'checkbox',
			'default' => 'off',
			),
			
            'thold_wechat_cropid' => array(
            'friendly_name' => 'Wechat CropID',
            'description' => 'Here is the WeChat enterprise number messaging application CropID',
            'method' => 'textbox',
			'size' => 80,
            'max_length' => 255,
            ),
			'thold_wechat_secret' => array(
            'friendly_name' => 'Wechat Secret',
            'description' => 'Here is the WeChat enterprise number messaging application Secret',
			'method' => 'textbox_password',
			'size' => 80,
			'max_length' => 255,
            ),
			'thold_wechat_appid' => array(
			...
			'description' => 'This is the comma separated list of Wechat User that the Dead Host Notifications will be sent to if the Global Notification List is selected.',
			'method' => 'textbox',
			'size' => 80,
			'max_length' => 255,
			),
			'thold_sendwechat_path' => array(
			'friendly_name' => 'Path to wechat script',
			'description' => 'This is the path to wechat script',
			'method' => 'filepath',
			'size' => 80,
			'max_length' => 255,
			'default' => $config['base_path'] . '/plugins/thold/extras/wechat.sh'
			)
	);
}
